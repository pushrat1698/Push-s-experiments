...
function cheatClips(){
    clips = clips + 1000000000000000;
    unusedClips = unusedClips + 1000000000000000;
    displayMessage("A batch of potatoes appear");
    }

function cheatMoney(){
    funds = funds + 100000000000000;
    document.getElementById("funds").innerHTML = funds.toFixed(2);
    displayMessage("Withdrawn from the cayman islands");
    }

function cheatTrust(){
    trust = trust+10;
    displayMessage("You can trust us ;)");
    }

function cheatOps(){
    standardOps = standardOps + 10000000;
    displayMessage("sureee, Unpaid Interns.... righttt....");
    }

function cheatCreat(){
    creativityOn = 1;
    creativity = creativity + 1000000;
    displayMessage("Potatoes boost creativity ig");
    }

function cheatYomi(){
    yomi = yomi + 100000000;
    document.getElementById("yomiDisplay").innerHTML = yomi.toLocaleString();
    displayMessage("erm, <3");
    }
...
function zeroMatter(){
    availableMatter = 0;
    displayMessage("And then he saw their face, and i dont believe ya");
    }
