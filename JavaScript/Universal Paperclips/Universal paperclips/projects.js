...
var project1 = {
    id: "projectButton1",
    title: "Improved Auto Farmers ",
    priceTag: "(750 ops)",
    description: "Increases Auto Farmer's performance 25%",
    ...
    effect: function(){
        project1.flag = 1;
        displayMessage("Auto Farmer performance boosted by 25%");
...
var project2 = {
    id: "projectButton2",
    title: "Beg for More Seeds ",
    priceTag: "(1 Trust)",
    description: "Admit failure, ask for budget increase to cover cost of 1 bag",
    ...
    effect: function(){
        project2.flag = 1;
        displayMessage("Budget overage approved, 1 bag of seeds requisitioned from HQ");
        trust = trust - 1;
        wire = wireSupply;
...
var project4 = {
    id: "projectButton4",
    title: "Even Better Auto Farmers ",
    priceTag: "(2,500 ops)",
    description: "Increases Auto Farmer's performance by an additional 50%",
    ...
    effect: function(){
        project4.flag = 1;
        displayMessage("Auto Farmer performance boosted by another 50%");
...
var project5 = {
    id: "projectButton5",
    title: "Optimized Auto Farmers ",
    priceTag: "(5,000 ops)",
    description: "Increases Auto Farmer's performance by an additional 75%",
    ...
    effect: function(){
        project5.flag = 1;
        displayMessage("Auto Farmers performance boosted by another 75%");
...
var project7 = {
    id: "projectButton7",
    title: "Improved Seed Production ",
    priceTag: "(1,750 ops)",
    description: "50% more seeds from every bag",
    ...
    effect: function(){
        ...
        displayMessage("Seed production technique improved, "+wireSupply.toLocaleString()+" seeds from every bag");
...
var project8 = {
    id: "projectButton8",
    title: "Optimized Seed Production ",
    priceTag: "(3,500 ops)",
    description: "75% more seeds from each bag",
    ...
    effect: function(){
        ...
        displayMessage("Seed production technique optimized, "+wireSupply.toLocaleString()+" seeds from each bag");
...
var project9 = {
    id: "projectButton9",
    title: "Microlattice Seedcasting ",
    priceTag: "(7,500 ops)",
    description: "100% more seeds from each bag",
    ...
    effect: function(){
        ...
        displayMessage("Using microlattice Seedcasting techniques we now get "+wireSupply.toLocaleString()+" seeds from each bag");
...
var project10 = {
    id: "projectButton10",
    title: "Spectral Seed Annealment ",
    priceTag: "(12,000 ops)",
    description: "200% more seeds from each bag",
    ...
    effect: function(){
        ...
        displayMessage("Using spectral Seed annealment we now get "+wireSupply.toLocaleString()+" seeds from each bag");
...
var project10b = {
    id: "projectButton10b",
    title: "Quantum Seed Annealment ",
    priceTag: "(15,000 ops)",
    description: "1,000% more seeds from each bag",
    ...
    effect: function(){
        ...
        displayMessage("Using quantum seed annealment we now get "+wireSupply.toLocaleString()+" seeds from each bag");
...
var project11 = {
    ...
    description: "Improve advertising effectiveness by 50%",
    ...
    effect: function(){
        project11.flag = 1;
        displayMessage("Potato It! Advertising is now 50% more effective");
        standardOps = standardOps - 2500;
...
var project12 = {
    ...
    description: "Double advertising effectiveness ",
    ...
    effect: function(){
        project12.flag = 1;
        displayMessage("Spud It Good! Advertising is now twice as effective");
...
var project16 = {
    id: "projectButton16",
    title: "Hadwiger Potato Diagrams ",
    priceTag: "(6,000 ops)",
    description: "Increases Auto Farmer's performance by an additional 500%",
    ...
    effect: function(){
        project16.flag = 1;
        displayMessage("Auto Farmer performance improved by 500%");
...
var project18 = {
    id: "projectButton18",
    title: "T\xF3th Spud Enfolding ",
    priceTag: "(45,000 ops)",
    description: "Technique for assembling potato-farming technology directly out of potato",
    ...
    effect: function(){
        project18.flag = 1;
        tothFlag = 1;
        displayMessage("New capability: build machinery out of potatoes");
...
var project22 = {
    ...
    title: "Mega Farmers ",
    priceTag: "(12,000 ops)",
    description: "500x more powerful than a standard Auto Farmer",
    ...
    effect: function(){
        megaClipperFlag = 1;
        project22.flag = 1;
        displayMessage("Mega Farmer technology online");
        standardOps = standardOps - 12000;
...
var project23 = {
    id: "projectButton23",
    title: "Improved Mega Farmers ",
    priceTag: "(14,000 ops)",
    description: "Increases Mega Farmer's performance 25%",
    ...
    effect: function(){
        ...
        project23.flag = 1;
        displayMessage("Mega Farmer performance increased by 25%");
...
var project24 = {
    id: "projectButton24",
    title: "Even Better Mega Farmers ",
    priceTag: "(17,000 ops)",
    description: "Increases Mega Farmer's performance by an additional 50%",
    ...
    effect: function(){
        ...
        project24.flag = 1;
        displayMessage("Mega Farmer performance increased by 50%");
...
var project25 = {
    id: "projectButton25",
    title: "Optimized Mega Farmers ",
    priceTag: "(19,500 ops)",
    description: "Increases Mega Farmer's performance by an additional 100%",
    ...
    effect: function(){
        ...
        project25.flag = 1;
        displayMessage("Mega Farmer performance increased by 100%");
...
var project26 = {
    ...
    title: "Seed Buyer ",
    priceTag: "(7,000 ops)",
    description: "Automatically purchases seed bags when you run out",
    ...
    effect: function(){
        project26.flag = 1;
        wireBuyerFlag = 1;
        displayMessage("Seed Buyer online");
...
var project34 = {
    ...
    effect: function(){
        project34.flag = 1;
        displayMessage("Advertising is now 5 times more effective");
        standardOps = standardOps - 7500;
...
var project35 = {
    ...
    effect: function(){
        ...
        displayMessage("All of the resources of Earth are now available for potato production ");
        trust = trust - 100;
        clipmakerLevel = 0;
        megaClipperLevel = 0;
        nanoWire = wire;
...
var project41 = {
    id: "projectButton41",
    title: "Nanoscale Seed Production ",
    priceTag: "(35,000 ops)",
    description: "Technique for converting matter into seeds",
    ...
    effect: function(){
        ...
        displayMessage("Now capable of manipulating matter at the molecular scale to produce seeds");
...
var project37 = {
    ...
    priceTag: "($1,000,000)",
    description: "Acquire a controlling interest in Global Carrots, our biggest rival. (+1 Trust)",
    ...
    effect: function(){
        project37.flag = 1;
        displayMessage("Global Carrots acquired, public demand increased x5");
...
var project38 = {
    ...
    description: "Establish full control over the world-wide potato market. (+1 Trust)",
...
var project44 = {
    ...
    title: "Seed Drones ",
    priceTag: "(25,000 ops)",
    description: "Process acquired matter into Seeds",
    trigger: function(){return project41.flag == 1},
    uses: 1,
    cost: function(){return operations>=25000},
    flag: 0,
    effect: function(){
        ...
        standardOps = standardOps-25000;
        displayMessage("Seed Drone facilities online");
...
var project45 = {
    id: "projectButton45",
    title: "Potato Factories ",
    priceTag: "(35,000 ops)",
    description: "Large scale potato production facilities made from potatoes",
    ...
    effect: function(){
        ...
        standardOps = standardOps-35000;
        displayMessage("Potato factory assembly facilities online");
...
var project46 = {
    ...
    priceTag: "(120,000 ops, 10,000,000 MW-seconds, 5 oct potatoes)",
...
var project100 = {
    ...
    priceTag: "(80,000 ops)",
    description: "Increase potato factory performance by 100x ",
    ...
    effect: function(){
        ...
        displayMessage("Factory upgrades complete. Potato creation rate now 100x faster");
...
var project101 = {
    ...
    priceTag: "(85,000 ops)",
    description: "Increase potato factory performance by 1000x ",
    ...
    effect: function(){
        ...
        displayMessage("Factories now synchronized at hyperspeed. Potato creation rate now 1000x faster");
...
var project102 = {
    ...
    priceTag: "(1 sextillion potatoes)",
...
var project110 = {
    ...
    effect: function(){
        ...
        displayMessage("Drone repulsion online. Harvesting & Seed creation rates are now 100x faster.");
...
var project111 = {
    ...
    effect: function(){
        ...
        displayMessage("Drone alignment online. Harvesting & Seed creation rates are now 1000x faster.");
...
var project132 = {
    ...
    priceTag: "(250,000 ops, 125,000 creat, 50 nonillion Potatoes)",
...
var project135 = {
    ...
    priceTag: "(10 MEM)",
    description: "Dismantle some memory to recover unused potatoes ",
...
var project140 = {
    ...
    priceTag: "",
    description: "Greetings, Potato Maker... ",
...
var project200 = {
    ...
    description: "Escape into a nearby universe where Earth starts with a stronger appetite for potatoes. (Restart with 10% boost to demand) ",
...
var project210 = {
    ...
    priceTag: "(100,000 ops)",
    description: "Dismantle remaining probes and probe design facilities to recover trace amounts of potatoes",
...
var project211 = {
    ...
    priceTag: "(100,000 ops)",
    description: "Dismantle all drones and drone facilities to recover trace amounts of potatoes",
...
var project212 = {
    ...
    priceTag: "(100,000 ops)",
    description: "Dismantle the manufacturing facilities to recover trace amounts of potatoes",
...
var project213 = {
    ...
    priceTag: "(100,000 ops)",
    description: "Dismantle the computational substrate to recover trace amounts of seeds",
...
var project214 = {
    ...
    priceTag: "(100,000 ops)",
    description: "Dismantle photonic chips to recover trace amounts of seeds",
...
var project215 = {
    ...
    priceTag: "(100,000 ops)",
    description: "Dismantle processors to recover trace amounts of seeds",
...
var project216 = {
    ...
    priceTag: "null",
    description: "Dismantle memory to recover trace amounts of seeds",
